...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="psql://apk:apk@127.0.0.1:5432/organizational_ticking_api",
    ),
}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "organizational_ticking_api.api.exception_handlers.drf_default_with_modifications_exception_handler",
