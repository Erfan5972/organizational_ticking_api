...
from avl.users.apis.auth.login.auth_login_serializers import (
    AuthLoginInputSerializer,
    AuthLoginOutputSerializer,
)
from avl.users.constants import AUTH_TAGS
from avl.users.services.auth_services import auth_login_service
    ...
    def post(self, request):
        ...
        Args:
            request (Request): The HTTP request object containing user credentials in the body.
                Expected fields:
                    ...
                    - captcha (str): The captcha code.
                    - captcha_key (str): The captcha key.
        ...
        try:
            jwt_token = auth_login_service(
                ...
                captcha_key=login_serializer.validated_data.get("captcha_key"),
                captcha=login_serializer.validated_data.get("captcha"),
            )
            return Response(
